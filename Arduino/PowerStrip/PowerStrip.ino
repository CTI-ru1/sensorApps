...
//Sensor S[5]={ 
//  Sensor("1s", A1), Sensor("2s", A2),Sensor("3s", A3),Sensor("4s", A4),Sensor("5s", A5)};
//Relay R[5]={ 
//  Relay("1r", 2,&S[0]), Relay("2r",4,&S[1]),Relay("3r",6,&S[2]),Relay("4r",8,&S[3]),Relay("5r",15,&S[4])};
//#ifdef USE_INDICATE
//Indicate I[5]={
//  Indicate("1i",3,&S[0]),Indicate("2i",5,&S[1]),Indicate("3i",7,&S[2]),Indicate("4i",14,&S[3]),Indicate("5i",16,&S[4])};
//#endif
//#else 
Coap coap;
int SenA,SenB, SenC, SenD, SenE, SenF, SenG;
Sensor S[7]={ 
  Sensor("1s", A1), Sensor("2s", A2),Sensor("3s", A3),Sensor("4s", A4),Sensor("5s", A5),Sensor("6s", A6),Sensor("7s", A7)};
Relay R[7]={ 
  Relay("1r", 2,&S[0]), Relay("2r",4,&S[1]),Relay("3r",6,&S[2]),Relay("4r",8,&S[3]),Relay("5r",15,&S[4]),Relay("6r",17,&S[5]),Relay("7r",19,&S[6])};
#ifdef USE_INDICATE
Indicate I[7]={
  Indicate("1i",3,&S[0]),Indicate("2i",5,&S[1]),Indicate("3i",7,&S[2]),Indicate("4i",14,&S[3]),Indicate("5i",16,&S[4]),Indicate("6i",18,&S[5]),Indicate("7i",20,&S[6])};
//#endif
...
void setup()
{
  ...
  void loop(){
    ...
    // if there is a request for your resource, your callback
